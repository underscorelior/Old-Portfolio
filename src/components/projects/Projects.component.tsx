  ...
  return (
    <div className="my-16 px-3 font-sen" id="projects">
      ...
      <div className="my-8 flex flex-col items-center justify-center gap-10 sm:flex-row">
        <a href="https://rf.underscore.wtf" className="h-[7rem] w-[14rem] cursor-pointer rounded-lg bg-gradient-to-r from-[#a268d1] via-[#9360d6] to-[#818CF8] p-1 text-white duration-100 hover:scale-105" target="_blank" rel="noopener noreferrer">
          <div className="flex h-full w-full flex-col items-center justify-center rounded-lg bg-pd hover:bg-primary px-2 text-center font-medium">
            <p className="text-xl font-semibold">Random Fun</p>
            <p>A decent discord bot with decent features</p>
          </div>
		    </a>
